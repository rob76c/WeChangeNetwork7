...
function register_org_admins() {
  ...
  register_org_admin fednow fednowadmin fednowadminpw
...
function enroll_org_admins() {
  ...
  enroll_org_admin peer     fednow fednowadmin fednowadminpw
...
function create_channel_MSP() {
  ...
  create_channel_org_MSP fednow peer $ORG2_NS
