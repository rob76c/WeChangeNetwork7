...
function launch_peers() {
  ...
  apply_template kube/fednow/fednow-peer1.yaml $ORG2_NS
  apply_template kube/fednow/fednow-peer2.yaml $ORG2_NS

  kubectl -n $ORG1_NS rollout status deploy/wechange-peer1
  kubectl -n $ORG1_NS rollout status deploy/wechange-peer2
  kubectl -n $ORG2_NS rollout status deploy/fednow-peer1
  kubectl -n $ORG2_NS rollout status deploy/fednow-peer2
...
function create_local_MSP() {
  ...
  create_peer_local_MSP fednow peer1 $ORG2_NS
  create_peer_local_MSP fednow peer2 $ORG2_NS
